...
export function MachineCard({ machine }: MachineCardProps) {
  ...
  return (
    <div className="group relative h-[492px] w-full overflow-hidden">
      ...
      <div className="absolute bottom-0 flex h-24 w-full items-center justify-between bg-surface/80 text-foreground backdrop-blur-md transition-all duration-500 translate-y-0 md:translate-y-24 md:group-hover:translate-y-0">
        <div className="pl-8">
